...
public class ProfileFragmentTest {
    ...
    @Test
    public void testProfilePictureIsNotNullAfterTakingPicture() throws InterruptedException {
        ...
        onView(withId(R.id.buttonTakePicture)).check(matches(not(noDrawable())));
    }
}